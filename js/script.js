...
function initScrollTop() {
    ...
    const $progressPath = $('.progress-circle path');
    const pathLength = 307.919; // Path length for r=49 circle

    // Ensure we start at top on page load/refresh (Route change simulation)
    ...
    $(window).on('scroll', function () {
        ...
        // Update Progress Circle Loader
        const progress = pathLength - (scrollPos * pathLength / height);
